        ...
        <CardContent>
          <Form {...form}>
            ...
            >
              ...
              <InputFieldset
                label="Description"
                description="Note: The product description is the main description for the product (Will display in every variant page). You can add an extra description specific to this variant using"
              >
